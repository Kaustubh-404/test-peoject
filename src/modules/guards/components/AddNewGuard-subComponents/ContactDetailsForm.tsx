...
//   // Handle phone number input change - with validation integration
//   const handleMobileNumberChange = (e: React.ChangeEvent<HTMLInputElement>) => {
//     const value = e.target.value;
//     const formatted = formatPhoneNumber(value);

//     if (setValue) {
//       setValue("contactDetails.mobileNumber", formatted);
//     }
...
//     // Clear validation if field is empty or less than 10 digits
//     if (!formatted || formatted.length < 10) {
//       clearValidation();
//       return;
//     }

//     // If exactly 10 digits, set up debounced validation
...
//   // Handle regular phone number change (for other fields)
...
//         // Check if phone exists (only show error if validation completed and exists)
//         if (exists && !isChecking) {
...
//     if (message && currentMobileNumber.length === 10) {
//       if (exists) {
//         return {
//           color: "#d32f2f",
//           message: message,
...
//                 error={!!(errors?.contactDetails?.mobileNumber || (exists && !isChecking))}
...
//               {/* Existing Guard Details */}
//               {validationDisplay?.existingGuard && (
//                 <Box
//                   sx={{
//                     mt: 0.5,
//                     p: 1,
...
//                     }}
//                   >
//                     Name: {validationDisplay.existingGuard.firstName} {validationDisplay.existingGuard.lastName}
//                   </Typography>
//                   <Typography
//                     sx={{
//                       fontSize: "11px",
...
//                     }}
//                   >
//                     Email: {validationDisplay.existingGuard.email}
//                   </Typography>
//                   <Typography
//                     sx={{
//                       fontSize: "11px",
...
//                     }}
//                   >
//                     Type: {validationDisplay.existingGuard.userType === "AREA_OFFICER" ? "Area Officer" : "Guard"}
//                   </Typography>
//                 </Box>
//               )}
//             </Box>
