...
export default function IncidentReports() {
  ...
  const incidentData = incidentResponse?.data?.incidents || [];
  const openCount = incidentResponse?.data?.openIncidents || 0;
  const closedCount = incidentResponse?.data?.closedIncidents || 0;
              ...
              return (
                <div key={incident.id} className="bg-white border border-gray-200 rounded-lg shadow-sm">
                  <div className="grid grid-cols-[1fr_2fr_1fr] gap-4 px-2 py-2 bg-white items-center">
                    ...
                    <div className="text-gray-800 font-medium break-words">{incident.siteName}</div>
