...
const guardTypeOptions = [
  ...
  { value: "GUN_MAN", label: "Gun Man" },
  { value: "LADY_GUARD", label: "Lady Guard" },
  { value: "BOUNCER", label: "Bouncer" },
  { value: "PERSONAL_GUARD", label: "Personal Guard" },
  { value: "HEAD_GUARD", label: "Head Guard" },
  { value: "SITE_SUPERVISOR", label: "Site Supervisor" },
];

const uniformOptions = [
  { value: "standard", label: "Standard Uniform" },
  { value: "corporate", label: "Corporate Uniform" },
  { value: "casual", label: "Casual Uniform" },
];
  ...
  return (
    <div className="bg-white p-4 rounded-lg flex flex-col relative border-2 border-gray-200">
      ...
      <div className="grid grid-cols-5 gap-4 mb-4">
        <LabeledDropdown
          label="Guard Type"
          name={`sitePosts.${sitePostIndex}.shifts.${shiftIndex}.guardRequirements.${guardIndex}.guardType`}
          ...
          error={!!errors.sitePosts?.[sitePostIndex]?.shifts?.[shiftIndex]?.guardRequirements?.[guardIndex]?.guardType}
          helperText={
            errors.sitePosts?.[sitePostIndex]?.shifts?.[shiftIndex]?.guardRequirements?.[guardIndex]?.guardType?.message
          }
        />
