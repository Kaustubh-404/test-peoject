...
interface UniformBottomErrors {
  photos?: { message?: string };
}

interface FormErrors {
  uniformBottom?: UniformBottomErrors;
}

interface UniformBottomFormProps {
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <IconButton onClick={goToPreviousImage} disabled={currentImageIndex === 0}>
                  <ChevronLeftIcon sx={{ width: "26px", height: "26px" }} />
                </IconButton>
                ...
                <IconButton onClick={goToNextImage} disabled={currentImageIndex === uploadedImages.length - 1}>
...
export default UniformBottomForm;
